...
std::vector<float> FeatureGenerator::generate(
  ...
  float *max_height_data, *mean_height_data, *count_data, *top_intensity_data,
  ...
  // if (use_constant_feature && use_intensity_feature) {
  //   direction_data = in_feature_ + siz * 3;
  //   distance_data = in_feature_ + siz * 6;
  // } else if (use_constant_feature) {
  //   direction_data = in_feature_ + siz * 3;
  //   distance_data = in_feature_ + siz * 4;
  // }
