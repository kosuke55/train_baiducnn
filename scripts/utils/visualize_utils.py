...
def viz_in_feature(
    ...
    non_empty_channle = 7
    non_empty = in_feature[..., non_empty_channle].astype(np.uint8) * 255
...
if __name__ == '__main__':
    viz_out_feature(
        data_path='/media/kosuke/SANDISK/nusc/mini-6c-672-yaw',
        idx=0, width=672, height=672, grid_range=70.,
        draw_instance_pt=False, draw_heading_pt=True)

        # draw_instance_pt=True, draw_heading_pt=False)

    # viz_out_feature(
    #     data_path='/media/kosuke/SANDISK/nusc/mini-0427',
